                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="job-list half-grid">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="{{asset('frontend/images/job/company-logo-8.png')}}" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="body">
                                            <div class="content">
                                    ...
                                    <div class="job-list half-grid">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="{{asset('frontend/images/job/company-logo-9.png')}}" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="body">
                                            <div class="content">
                                    ...
                                    <div class="job-list half-grid">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="{{asset('frontend/images/job/company-logo-10.png')}}" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="body">
                                            <div class="content">
                                    ...
                                    <div class="job-list half-grid">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="{{asset('frontend/images/job/company-logo-3.png')}}" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="body">
                                            <div class="content">
                                ...
                                <div class="col-lg-6">
                                    <div class="job-list half-grid">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="{{asset('frontend/images/job/company-logo-1.png')}}" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="body">
                                            <div class="content">
                                    ...
                                    <div class="job-list half-grid">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="{{asset('frontend/images/job/company-logo-2.png')}}" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="body">
                                            <div class="content">
                ...
                <div class="col">
                    <div class="company-carousel owl-carousel">
                        <div class="company-wrap">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{asset('frontend/images/company/company-logo-1.png')}}" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="body">
                        ...
                        <div class="company-wrap">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{asset('frontend/images/company/company-logo-2.png')}}" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="body">
                        ...
                        <div class="company-wrap">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{asset('frontend/images/company/company-logo-3.png')}}" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="body">
                        ...
                        <div class="company-wrap">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{asset('frontend/images/company/company-logo-4.png')}}" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="body">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="call-to-action-box candidate-box">
                        <div class="icon">
                            <img src="{{asset('frontend/images/register-box/1.png')}}" alt="">
                        </div>
                        <span>Are You</span>
                        <h3>Candidate?</h3>
                ...
                <div class="col-lg-6">
                    <div class="call-to-action-box employer-register">
                        <div class="icon">
                            <img src="{{asset('frontend/images/register-box/2.png')}}" alt="">
                        </div>
                        <span>Are You</span>
                        <h3>Employer?</h3>
                ...
                <div class="col-md-12">
                    <div class="testimonial">
                        <div class="testimonial-quote">
                            <img src="{{asset('frontend/images/testimonial/quote.png')}}" class="img-fluid" alt="">
                        </div>
                        ...
                        <div class="testimonial-nav">
                            <div class="commenter-thumb">
                                <img src="{{asset('frontend/images/testimonial/thumb-1.jpg')}}" class="img-fluid commenter" alt="">
                                <img src="{{asset('frontend/images/testimonial/1.png')}}" class="comapnyLogo" alt="">
                            </div>
                            <div class="commenter-thumb">
                                <img src="{{asset('frontend/images/testimonial/thumb-2.jpg')}}" class="img-fluid commenter" alt="">
                                <img src="{{asset('frontend/images/testimonial/2.png')}}" class="comapnyLogo" alt="">
                            </div>
                            <div class="commenter-thumb">
                                <img src="{{asset('frontend/images/testimonial/thumb-3.jpg')}}" class="img-fluid commenter" alt="">
                                <img src="{{asset('frontend/images/testimonial/3.png')}}" class="comapnyLogo" alt="">
                            </div>
                            <div class="commenter-thumb">
                                <img src="{{asset('frontend/images/testimonial/thumb-4.jpg')}}" class="img-fluid commenter" alt="">
                                <img src="{{asset('frontend/images/testimonial/4.png')}}" class="comapnyLogo" alt="">
                            </div>
                            <div class="commenter-thumb">
                                <img src="{{asset('frontend/images/testimonial/thumb-5.jpg')}}" class="img-fluid commenter" alt="">
                                <img src="{{asset('frontend/images/testimonial/5.png')}}" class="comapnyLogo" alt="">
                            </div>
                            <div class="commenter-thumb">
                                <img src="{{asset('frontend/images/testimonial/thumb-2.jpg')}}" class="img-fluid commenter" alt="">
                                <img src="{{asset('frontend/images/testimonial/2.png')}}" class="comapnyLogo" alt="">
